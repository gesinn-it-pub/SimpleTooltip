...
include::docs/gesinn-it-docs-master-pub/sections/universal/semver.adoc[]

include::docs/gesinn-it-docs-master-pub/documents/mediawiki/contributing.adoc[leveloffset=+1]
